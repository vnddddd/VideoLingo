...
PLUGIN_CONFIG_SCHEMA: dict[str, dict[str, Any]] = {
    ...
    "fish_audio_tts.api_key": {"type": "str"},
    "fish_audio_tts.model": {"type": "str"},
    "fish_audio_tts.mode": {"type": "str"},
    "fish_audio_tts.reference_id": {"type": "str"},
    "fish_audio_tts.chunk_length": {"type": "int", "min": 100, "max": 300},
    "fish_audio_tts.temperature": {"type": "float", "min": 0, "max": 1},
    "fish_audio_tts.max_voice_slots": {"type": "int", "min": 0, "max": 100},
